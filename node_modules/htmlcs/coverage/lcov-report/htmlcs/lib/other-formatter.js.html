...
&nbsp;
        // javascript content
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!type || <span class="branch-1 cbranch-no" title="branch not covered" >type === 'text/javascript')</span> {
